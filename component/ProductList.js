  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.desc}>
        Walcart, with the slogan of Shohoje, Sobkhane, Nirapode (Easy, Everywhere, Safely), is a
        business-to-business and business-to-customer e-commerce platform through which the company
        is providing countrywide delivery services of the products and services in more than 30
        categories, including Walton products.
      </p>
      ...
      <div className="container">
        ...
        <div>
          <div className="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div className="col">
              <div className="card h-100">
                <img src="/img/fridge2.jpg" className="card-img-top" alt="..." />
                <div className="card-body">
      ...
      <div className="container">
        ...
        <div>
          <div className="row row-cols-1 row-cols-md-2 g-4">
            <div className="col">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    This is a longer card with supporting text below as a natural lead-in to
                    additional content. This content is a little bit longer.This content is a little
                    bit longer.This content is a little bit longer.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col">
              <div className="card">
                <img src="/img/AC3.jpg" className="card-img-top" alt="..." />
                <div className="card-body">
            ...
            <div className="col">
              <div className="card">
                <img src="/img/AC4.jpg" className="card-img-top" alt="..." />
                <div className="card-body">
